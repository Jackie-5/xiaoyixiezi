import baseBehavior from '../../../dist/helpers/baseBehavior'
import mergeOptionsToData from '../../../dist/helpers/mergeOptionsToData'
import { getTouchPoints, getPointsNumber, getPointsDistance } from '../../../dist/helpers/gestures'
...
Component({
  ...
  methods: {
    ...
    setImage(opts) {
      ...
      const test = [ ...this.data.images];
      test.push({ ...opts.urls[0], touch: { ...defaultTouchOptions } });
      console.log(test);
      this.$$setData({
